import productDetails from "./ProductDetails.Styles";
...
const ProductDetails = () => {
  ...
  const renderProductSuccessView = () => {
    return (
      <Box sx={productDetailsStyles.productDetailsMainContainer}>
        <Box sx={productDetailsStyles.logoutBox}>
          <Button
            type="button"
            onClick={onLogoutClick}
            sx={productDetailsStyles.logoutBtn}
          >
            Logout
          </Button>
        </Box>
  ...
  return (
    <Box sx={productDetails.mainContainer}>
      <Box sx={productDetails.childContainer}>
